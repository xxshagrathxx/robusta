        ...
        <div class="col-lg-12 mb-4 order-0">
            ...
            <div class="card mb-4">
                <div class="d-flex align-items-end row">
                    <div class="col-sm-12">
                        <div class="card-body">
                            <h5 class="card-title text-primary">{{ transWord('Create Bus') }}</h5>
                            <form action="{{ route('buses-store') }}" method="post">
                                ...
                                <div class="col-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="total_seats" placeholder="Enter Total Seats" value="{{ old('total_seats') }}" />
